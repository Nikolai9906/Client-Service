...
public class DataBase {
	 ...
	 */
	public DataBase() {
		MongoClient mongoClient = new MongoClient( new MongoClientURI("mongodb://admin:1234@cluster0-shard-00-00.dcoua.mongodb.net:27017,cluster0-shard-00-01.dcoua.mongodb.net:27017,cluster0-shard-00-02.dcoua.mongodb.net:27017/shoesArep?ssl=true&replicaSet=atlas-lw64uc-shard-0&authSource=admin&retryWrites=true&w=majority"));
		MongoDatabase database = mongoClient.getDatabase("shoesArep");
		columnas = database.getCollection("Shoes");
	}
